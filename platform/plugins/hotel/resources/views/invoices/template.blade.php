        ...
        <div class="flexbox-annotated-section">
            <div class="flexbox-annotated-section-annotation">
                <div class="annotated-section-title pd-all-20">
                    <h2>{{ trans('plugins/hotel::invoice.template.setting') }}</h2>
                </div>
                <div class="annotated-section-description pd-all-20 p-none-t">
                    <p class="color-note">
                        {!! BaseHelper::clean(trans('plugins/hotel::invoice.template.setting_description')) !!}
                    </p>
                </div>
            </div>
                ...
                <div class="wrapper-content pd-all-20 email-template-edit-wrap">
                    <div class="form-group mb-3">
                        <label
                            ...
                            for="email_content"
                        >{{ trans('plugins/hotel::invoice.template.setting_content') }}</label>
