                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form_modal_calendar form-horizontal" novalidate onsubmit="return false">
                            <div class="form-group">
                                ...
                                <br />
                                <label
                                    ><input type="checkbox" true-value="1" false-value="0" v-model="form.active" />
                                    {{ __('room_availability.is_available') }}</label
                                >
                            </div>
                            <div class="row">
                                <div class="col-md-6" v-show="form.active">
                                    <div class="form-group">
                                        <label for="price-input">{{ __('room_availability.value') }}</label>
                                        <input
                                            type="number"
                                            id="price-input"
                                            v-model="form.value"
                            ...
                            <div class="row" v-if="form.value_type === 'percentage_adjust'">
                                ...
                                <div class="col-md-6" v-show="form.active">
                                    <div class="form-group">
                                        <label for="number-of-rooms">{{
                                            __('room_availability.number_of_rooms')
                                        }}</label>
                                        <input
                                            type="number"
                                            id="number-of-rooms"
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
                            {{ __('room_availability.close') }}
                        </button>
                        <button type="button" class="btn btn-primary" @click="saveForm">
                            {{ __('room_availability.save_changes') }}
                        </button>
                    </div>
                </div>
            </div>
